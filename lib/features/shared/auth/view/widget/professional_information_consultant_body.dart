              ...
              Positioned(
                ...
                child: BlocConsumer<AuthCubit, AuthState>(
                  listenWhen: (previous, current) =>
                      previous.personalDataState != current.personalDataState,
                  listener: (context, state) {
                    ...
                    } else if (state.personalDataState == CubitStates.failure) {
                      context.pop();
                    ...
                    } else if (state.personalDataState == CubitStates.loading) {
                      showDialog(
                        context: context,
                  ...
                  builder: (context, state) {
                    return CustomBotton(
                      width: context.width,
                      useGradient: true,
                      title: state.personalDataState == CubitStates.loading
                          ? context.tr('sending')
                          : context.tr('next'),
                      onPressed: () {
