// features/advisor/profile/views/widgets/profile_post_card.dart
...
// ═══════════════════════════════════════════════════════════
// Profile Post Media (مع حل مشكلة Hero)
// ═══════════════════════════════════════════════════════════
class _ProfilePostMedia extends StatefulWidget {
  final PostModel post;
  final bool isDetailsView;
  final VideoPlayerController? sharedController;
  ...
  @override
  State<_ProfilePostMedia> createState() => __ProfilePostMediaState();
}

class __ProfilePostMediaState extends State<_ProfilePostMedia> {
  VideoPlayerController? _activeController;
