...
class _EmailEditScreenState extends State<EmailEditScreen> {
  ...
  Widget _buildEmailInputField(BuildContext context, EmailEditState state) {
    final hasError = state.visibleError.isNotEmpty;
          ...
          Material(
            ...
            child: Container(
              ...
              child: TextFormField(
                ...
                onChanged: (v) => context.read<EmailEditCubit>().updateEmail(
                  v,
                  markDirty: true,
                ),
              ),
  ...
  void _syncController(EmailEditState state) {
  ...
  void _handleStateChanges(BuildContext context, EmailEditState state) {
    if (state.errorMessage.isNotEmpty) {
      ...
      Future.delayed(const Duration(milliseconds: 1400), () async {
        ...
        if (mounted) context.read<EmailEditCubit>().reset();
      });
