  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => ConsultationCubit(
        repo: ConsultationFiltterRepoImpl(),
      ),
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            ...
            style: Styles.textStyle24Meduim
        ...
        body: Column(
          children: [
            // ✅ SearchBarWithFilter widget — import من المكان الصح
            Padding(
              padding:
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return AdvisorConsultationCard(
                        advisor: advisor,
                        isSelected: index == 0, // أول مستشار = recommended
                      );
                    },
                  );
                },
