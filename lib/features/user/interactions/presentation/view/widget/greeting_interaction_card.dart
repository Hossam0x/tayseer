...
class GreetingProfileCard extends StatelessWidget {
  ...
  const GreetingProfileCard({super.key, required this.item});
...
//   Widget build(BuildContext context) {
//     return Container(
//       height: 140.h, // Wide card as seen in the screenshot
//       padding: EdgeInsets.all(12.w),
//       decoration: BoxDecoration(
...
//                 Row(
//                   children: [
//                     _buildBadge(text: item['day'], icon: null),
//                     SizedBox(width: 4.w),
//                     _buildBadge(
//                       text: item['country'],
//                       icon: AssetsData.EgyFlagIcon,
...
//                   colors: [AppColors.primary200, AppColors.primary400],
//                 ),
//                 // 2. Drop Shadow: 0px 2.87px, 37.85px blur
//                 boxShadow: [
//                   BoxShadow(
//                     color: const Color(
//                       0xFF48174E,
//                     ).withOpacity(0.2), // rgba(72, 23, 78, 0.2)
//                     offset: const Offset(0, 2.87),
//                     blurRadius: 37.85,
//                     spreadRadius: 0,
//                   ),
...
//       padding: EdgeInsets.symmetric(horizontal: 10.w, vertical: 4.h),
//       decoration: BoxDecoration(
//         color: Color.fromRGBO(186, 186, 186, 0.24),
