...
class ChooseAgeBody extends StatefulWidget {
  const ChooseAgeBody({super.key});

  @override
  State<ChooseAgeBody> createState() => _ChooseAgeBodyState();
}

class _ChooseAgeBodyState extends State<ChooseAgeBody> {
                ...
                builder: (context, state) {
                  return Padding(
                    ...
                    child: CustomBotton(
                      ...
                      useGradient: true,
                      onPressed: () {
                        debugPrint('AGE TO API: $selectedAge');
