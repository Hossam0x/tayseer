// lib/features/user/questions/view/screens/children_living_status_body.dart
...
class ChildrenLivingStatusBody extends StatelessWidget {
  ChildrenLivingStatusBody({super.key});

  /// ValueNotifier لتتبع القيمة المختارة
  final ValueNotifier<String?> _selectedValue = ValueNotifier<String?>(null);

  /// قائمة حالات إقامة الأطفال (keys للترجمة)
  final List<String> _livingStatusItems = const [
    'living_currently',
    'living_future',
