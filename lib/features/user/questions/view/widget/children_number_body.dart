// lib/features/user/questions/view/screens/children_number_body.dart
...
class ChildrenNumberBody extends StatelessWidget {
  ChildrenNumberBody({super.key});

  /// ValueNotifier لتتبع القيمة المختارة
  final ValueNotifier<String?> _selectedValue = ValueNotifier<String?>(null);

  /// قائمة عدد الأطفال (keys للترجمة)
  final List<String> _childrenNumberItems = const [
    'child_1',
    'child_2',
    'child_3',
    'child_4',
        ...
        return BlocConsumer<QuestionsCubit, QuestionsState>(
          ...
          listener: (context, state) {
            if (state.answerQuestionsState == CubitStates.success) {
              context.pushReplacementNamed(AppRouter.kChildrenLivingStatusView);
