// lib/features/user/questions/view/screens/wearing_hijab_body.dart
...
class WearingHijabBody extends StatelessWidget {
  WearingHijabBody({super.key});
  ...
  final List<String> _hijabItems = const ['yes', 'no'];
        ...
        return BlocConsumer<QuestionsCubit, QuestionsState>(
          ...
          listener: (context, state) {
            if (state.answerQuestionsState == CubitStates.success) {
              // TODO: هنا تحط الاسكرين اللي بعد السؤال ده
              // context.pushReplacementNamed(AppRouter.kNextStepView);
