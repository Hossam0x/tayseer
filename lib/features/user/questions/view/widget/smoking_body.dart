// lib/features/user/questions/view/screens/smoking_body.dart
...
class SmokingBody extends StatelessWidget {
  SmokingBody({super.key});
  ...
  final List<String> _smokingItems = const ['yes', 'no'];
        ...
        return BlocConsumer<QuestionsCubit, QuestionsState>(
          ...
          listener: (context, state) {
            if (state.answerQuestionsState == CubitStates.success) {
              context.pushReplacementNamed(AppRouter.kReligiousCommitmentView);
